...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L378-L407)
### `*defaults*`

Default settings for `process` invocations.

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L189-L193)
### `check`
<code>[proc]</code><br>

Takes a process, waits until is finished and throws if exit code is non-zero.

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L92-L106)
### `destroy`
<code>[proc]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L147-L153)
### `destroy-tree`
<code>[proc]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L157-L162)
### `exec`
<code>[cmd]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L429-L450)
### `pb`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L251-L260)
### `pipeline`
<code>[proc]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L325-L331)
### `pipeline`
<code>[proc]</code><br>
<code>[pb & pbs]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L332-L359)
### `process`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L270-L322)
### `sh`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L409-L419)
### `start`
<code>[pb]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L361-L365)
### `tokenize`
<code>[s]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L12-L59)
