...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L378)
### `*defaults*`

Default settings for `process` invocations.

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L189)
### `check`
<code>[proc]</code><br>

Takes a process, waits until is finished and throws if exit code is non-zero.

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L92)
### `destroy`
<code>[proc]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L147)
### `destroy-tree`
<code>[proc]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L157)
### `exec`
<code>[cmd]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L429)
### `pb`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L251)
### `pipeline`
<code>[proc]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L325)
### `pipeline`
<code>[proc]</code><br>
<code>[pb & pbs]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L332)
### `process`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L270)
### `sh`
<code>[cmd]</code><br>
<code>[cmd opts]</code><br>
<code>[prev cmd opts]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L409)
### `start`
<code>[pb]</code><br>

[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L361)
### `tokenize`
<code>[s]</code><br>
...
[Source](https://github.com/babashka/process/blob/quickdoc/src/babashka/process.cljc#L12)
